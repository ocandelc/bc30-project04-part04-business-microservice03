/**
 * Resumen.
 * Objeto                   : OperationTypeDaoInte.java
 ...
 */
public interface OperationTypeDaoInte extends ReactiveMongoRepository<OperationType, String>{
    Mono<OperationType> findByCodeOperationType(String codeOperationType);
}
